...
const emptyMember = { name: "", role: "", bio: "", sort_order: 0 };
        ...
        {members.map((m) => (
          <div key={m.id} className="bg-card border border-border rounded-xl p-5">
            ...
            <div className="flex gap-2 mt-3">
              <button onClick={() => { setEditing(m); setForm({ name: m.name, role: m.role, bio: m.bio || "", sort_order: m.sort_order }); }} className="p-1.5 text-muted-foreground hover:text-foreground"><Pencil className="w-4 h-4" /></button>
