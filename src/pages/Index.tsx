...
import { useServices, useTeamMembers, useTestimonials } from "@/hooks/useOptimizedData";
...
const Index = () => {
  ...
  const isLoading = servicesLoading || teamLoading || testimonialsLoading;
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, ease: "easeOut" }}>
              ...
              <p className="hero-desc">Book trusted electricians for installation, repair, and maintenance. Fast, reliable, and affordable electrical services with 24/7 support.</p>
              <div className="hero-btns">
                <Link to="/booking" className="hero-btn-primary">
                  <Zap size={16} /> Book Service Now <ArrowRight size={16} />
                </Link>
                <Link to="/services" className="hero-btn-secondary">View All Services</Link>
              </div>
